  ...
  return (
    <div className="min-h-screen flex justify-center items-center relative overflow-hidden text-white"
      ...
      <div className="z-10 glass rounded-2xl shadow-2xl w-full max-w-md mx-4 sm:mx-0 p-8 border border-violet-500/20">
        ...
        <p className="text-center text-sm text-slate-400 mb-6">Enter your email to receive a reset link</p>

        {error && (
          <div className="bg-rose-500/20 border border-rose-500/40 text-rose-200 p-3 rounded-lg mb-4 text-sm text-center">
            {error}
          </div>
        )}
        {message && (
          <div className="bg-emerald-500/20 border border-emerald-500/40 text-emerald-200 p-3 rounded-lg mb-4 text-sm text-center">
            {message}
          </div>
        )}
